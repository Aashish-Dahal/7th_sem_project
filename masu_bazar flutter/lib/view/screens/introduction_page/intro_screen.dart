  ...
  List<PageViewModel> getPages() {
    return [
      PageViewModel(
        ...
        body:
            "Meat Mart is an e-commerce platform where you can buy and sell your domestic animals and their edible meats",
        image: Center(
      ...
      PageViewModel(
        ...
        image: Center(
          child:
              Image.asset("assets/introduction_image/img3.png", height: 220.0),
        ),
        decoration: pageDecoration,
      ),
      PageViewModel(
