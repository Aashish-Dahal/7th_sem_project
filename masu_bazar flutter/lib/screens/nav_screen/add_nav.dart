                          ...
                          setState(() {
                            if (_formKey.currentState.validate()) {
                              ...
                              String inputcategory =
                                  _currentCategorySelected.toString();
                              ...
                              String inputcolor =
                                  colorController.text.toString().trim();
                              int inputdaat =
                                  int.parse(daatController.text.toString());
                              String name =
                                  nameController.text.toString().trim();
                              String address =
                                  addressController.text.toString().trim();
                              int phnNo = int.parse(
                                  primaryContactController.text.toString());
                              int contactNo = int.parse(
                                  secondaryContactController.text.toString());
                              int inputage =
                              ...
                              createPost(khasiModel).then((response) {
                                print(response.body);
                        ...
                        onPressed: () {
                          ...
                          setState(() {
                            ...
                            if (_formKey.currentState.validate()) {
                              ...
                              updatePost(khasiModel).then((response) {
                                if (response.statusCode == 201) {
                                  print(response);
                                  showDialog(
                                    context: context,
