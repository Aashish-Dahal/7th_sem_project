          ...
          return InkWell(
            onTap: () {
               Navigator.of(context).push(MaterialPageRoute(
                            ...
                            shortDescription: henModel.khasiList[index]
                                ["description"],
                            khasiImage: henModel.khasiList[index]["image"],
                            estimatedWeight:int.parse( henModel.khasiList[index]["weight"]),
                            ownerName: henModel.khasiList[index]["name"],
                            color: henModel.khasiList[index]["color"],
                            primaryContactNo:int.parse( henModel.khasiList[index]["number"]),
                            secondaryContactNo:int.parse( henModel.khasiList[index]["snumber"]),
                            daat: 2,
