          ...
          builder: (context,snapshot){
            if(snapshot.hasError)
            {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context,index){
                  ...
                  return listItem.category!='Khasi'?Center(child:null): 
                  GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(builder: (_)=>Details(
                         title_details: listItem.title,
                         image_details: 'assets/khasi_list/hen4.jpeg',
                         description_details: listItem.shortDescription,
                         weight_details: listItem.estimatedWeight,
                         location_details: listItem.address,
                         name_details: listItem.ownerName,
                         price_details: listItem.price,
                        daat_details: listItem.daat,
                        color_details: listItem.color,
                        date_details: listItem.date,
                        age_details: listItem.age,
                        pnumber_details: listItem.primaryContactNo,
                         snumber_details: listItem.secondaryContactNo,
            ...
            Text("Rs."+listItem.price.toString(), style: TextStyle(fontWeight: FontWeight.w400,fontSize: 12),),
              ...
              Positioned(
                ...
                top: 38.0,
                bottom: 0.0,
            child: Image(image: AssetImage('assets/khasi_list/khasi1.jpg'),width: 100,height: 10,fit: BoxFit.contain,)
              ),
          ],
        ),
                  );
